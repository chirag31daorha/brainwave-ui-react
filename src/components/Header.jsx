  ...
  return (
    ...
    lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}`}>
     ...
     max-lg:py-4">
            ...
            <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
                {navigation.map((item) => (
                    ...
                    className={`block relative font-code text-2xl uppercase text-n-1
                     transition-colors hover:text-color-1 ${item.onlyMobile ? 
                        "lg:hidden" : "" } px-6 py-6 md:py-8 lg:-mr-0.25
        ...
        <a className="button hidden mr-8 text-n-1/50
        transition-colors hover:text-n-1 lg:block hover:cursor-pointer">
            New Account
        </a>
